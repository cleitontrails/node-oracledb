# oracledb-10g <img src="https://img.shields.io/npm/v/oracledb-10g.svg" alt="oracledb-10g"/>

The node-oracledb add-on for Node.js powers high performance Oracle Database
applications.  Applications can be written in TypeScript, or directly in
JavaScript.

Use node-oracledb 7.0.1 to connect Node.js 14.17, or later, to Oracle
...
`binding.gyp` are excluded from the npm tarball, and the package sets
`"gypfile": false` so npm never injects the implicit `node-gyp rebuild`
install script. Installing it requires no compiler, no Oracle Instant
Client, and no ODPI-C sources.
